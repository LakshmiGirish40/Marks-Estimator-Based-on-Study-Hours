...
st.write("<h5 style='text-align: left;color:'brown',textColor:"#31333F">Predict student marks based on the number of hours they study in a day.</h5>", unsafe_allow_html=True) 
