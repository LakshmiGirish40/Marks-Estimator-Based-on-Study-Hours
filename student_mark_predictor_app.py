...
set_background('image2.jpeg')


#======================================================

st.title("Student Marks Prediction App")
st.write("<h5 style='text-align: left;color:brown'>Predict student marks based on the number of hours they study in a day.</h5>", unsafe_allow_html=True) 
